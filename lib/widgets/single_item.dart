...
class _SingleItemState extends State<SingleItem> {
  ReviewCartProvider
      reviewCartProvider; // added late identifier for late initiation

  int count; // added late identifier for late initiation
  getCount() {
    setState(() {
                      ...
                      : Padding(
                          ...
                          child: Column(
                            children: [
                              InkWell(
                                onTap: widget
                                    .onDelete, // added parenthesis for initiating the function
                                child: Icon(
                                  Icons.delete,
                                  size: 30,
